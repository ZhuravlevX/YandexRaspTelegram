...
use crate::routes::mosmetro::troika::transport_card::connect_otp::get_connect_otp;
use crate::routes::mosmetro::troika::transport_card::get_transport_card;
        ...
        web::scope("/mosmetro")
            ...
            .service(
                web::scope("/troika")
                    ...
                    .service(
                        web::scope("/transport_card")
                            .service(get_transport_card)
